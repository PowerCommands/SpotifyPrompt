...
public class TrackManager : SpotifyClientBase, ITrackManager
{
    private readonly ILogger<TrackManager> _logger = LoggerProvider.CreateLogger<TrackManager>();

    private TrackManager() { }
    private static readonly Lazy<ITrackManager> Instance = new(() => new TrackManager());
    public static ITrackManager Default => Instance.Value;
